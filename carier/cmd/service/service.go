...
var fs = flag.NewFlagSet("carier", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("carier", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		pb.RegisterCarierServer(baseServer, grpcServer)
