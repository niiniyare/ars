...
type OrderCreateAllowedRequestsTicketed struct {

	OrderCancel bool `json:"OrderCancel,omitempty"`

	OrderCancelToVoucher bool `json:"OrderCancelToVoucher,omitempty"`

	OrderReshop bool `json:"OrderReshop,omitempty"`

	OrderReshopRefund bool `json:"OrderReshopRefund,omitempty"`
